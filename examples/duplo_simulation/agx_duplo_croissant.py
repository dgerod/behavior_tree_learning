"""
Simulation environment for stacking duplo bricks in a croissant like structure
"""
import sys
...
def build_scene(rosid=10, visual=True):
    ...
    brick_types = [duplo_bricks.BrickTypes.STANDARD2X2, \
                   duplo_bricks.BrickTypes.STANDARD4X2, \
    ...
    #Goal positions, uncomment for testing
    #x_pos = [0.0, 0.0, 0.016, 0.016, 0, 0.05,-0.05, 0, 0.05 ]
    #y_pos = [0.0, 0.0, -0.032, 0.032, -0.05, -0.05, 0, 0, 0]
    #z_pos = [0.0, 0.0192, 0.0, 0.0, -0.05, -0.05, 0, 0, 0]
    ...
    scene_settings.listener_pool = common_functions.ListenerPool(size=20)
