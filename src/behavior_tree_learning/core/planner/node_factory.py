...
from behavior_tree_learning.core.sbt.behavior_factory import BehaviorNodeFactory as SbtBehaviorFactory
...
class BehaviorNodeFactory:
    ...
    def __init__(self, make_execution_node, get_condition_parameters):
        ...
        self._behavior_factory = SbtBehaviorFactory(make_execution_node)
    ...
    def get_node(self, name: str, world, condition_parameters):
        ...
        node = SbtBehaviorFactory().make_node(name)
        if node is None:
